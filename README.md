...
Final Year Project (BS Electrical Engineering) — University of Engineering and Technology (UET), Lahore, Narowal Campus, Session 2022–2026.
...
├── assets/                   # (add photos/diagrams of your build here)
└── README.md
```
Hardware Used
